...
def test_get_acq_catalog_19387():
    ...
    exp = ['<AcqTable length=11>',
           ...
           '    6     6 37881728  2046.89  1910.79   100',
           '    7     7 37880376 -1356.71  1071.32   100',
           '    8   -99 38276824 -1822.26 -1813.66   120',
           '    9   -99 37880152 -1542.43   970.39   120',
           '   10   -99 37882776  1485.00   127.97   120']
...
def test_get_acq_catalog_21007():
    ...
    exp = ['<AcqTable length=14>',
           ...
           '   11   -99 189417392   163.37   165.65   120',
           '   12   -99 189017968  1612.35 -1117.76   120',
...
def test_box_strategy_20603():
    ...
    exp = ['<AcqTable length=13>',
           ...
           '    1     1 116791824   622.00  -953.60   160',
           '    2     2 116923496 -1337.79  1049.27   120',
           '    3     3  40114416   394.22  1204.43   160',
           '    4     4  40112304 -1644.35  2032.47    80',
           '    5     5 116923528 -2418.65  1088.40   160',
           '    6     6 116791744   985.38 -1210.19    60',
           '    7   -99  40108048     2.21  1619.17   120',
           '    8     7 116785920  -673.94 -1575.87    60',
           '    9   -99 116791664  2307.25 -1504.54   120',
           '   10   -99 116792320   941.59 -1784.10   120',
           '   11   -99 116923744  -853.18   937.73   120',
           '   12   -99 116918232 -2074.91 -1769.96   120']
