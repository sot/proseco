...
def test_get_acq_catalog_19387():
    ...
    exp = ['<AcqTable length=11>',
           ...
           '    4    4 37882416   481.94  2204.45   100   10.41   0.865',
           '    5    5 37880176   121.41 -1068.31    60   10.62   0.584',
           '    6    6 37881728  2046.89  1910.76   100   10.76   0.057',
           '    7    7 37880376 -1356.67  1071.28   100   10.80   0.084',
           '    8  ... 38276824 -1822.25 -1813.62   120   10.86   0.017',
           '    9  ... 37880152 -1542.45   970.34   120   10.88   0.008',
...
def test_get_acq_catalog_21007():
    ...
    exp = ['<AcqTable length=14>',
           ...
           '    6    6 189406216 -2311.89  -240.17    80   10.26   0.514',
