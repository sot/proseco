...
---- --- --- ---- --- ----- ----- ------ -------- -------- --- --- -----
   ...
   1   2   4  FID 8x8 0.000     7   8.00  2140.23   166.63   1   1    25
   2   3   5  FID 8x8 0.000  7.00   8.00 -1826.28   160.17   1   1    25
   3   4 101  BOT 6x6 0.935 9.501  11.00     0.00  1500.00  20   1   160
...
---- --- --- ---- --- ----- ----- ------ -------- -------- --- --- -----
   ...
   4   5 105  BOT 6x6 0.981  7.50   9.00   750.00  -750.00  20   1   160
   5   6 106  BOT 6x6 0.982  7.00   8.50  -750.00   750.00  20   1   160
   6   7 100  MON 8x8 0.982  6.50   8.00  -750.00  -750.00  20   1    25
   7   8 103  GUI 6x6 0.000   8.5  10.00     0.00 -1500.00   1   1    25
   7   9 104  ACQ 6x6 0.980  8.00   9.50   750.00   750.00  20   1   160
   0  10 102  ACQ 6x6 0.966  9.00  10.50 -1500.00     0.00  20   1   160
   1  11 108  ACQ 6x6 0.551 10.50  11.20   300.00   300.00  20   1    60
""")
...
def test_diff_unified():
    ...
    assert diff.text.splitlines() == [
        ...
        '@@ -8,12 +8,12 @@',
        '',
        '   8 103    7  GUI  8.50 6x6   1   1    25',
        '   5 105    4  GU*  7.50 6x6   1   1    25',
        '   6 106    5  GU*  7.00 6x6   1   1    25',
        '-  7 107    6  GU*  6.50 6x6   1   1    25',
        '+--- --- ---- ---- ----- --- --- --- -----',
        '+  7 100    6  MON  6.50 8x8  20   1    25',
        ' --- --- ---- ---- ----- --- --- --- -----',
        '   4 101    3  AC*  9.50 6x6  20   1   160',
        '  10 102    0  ACQ  9.00 6x6  20   1   160',
...
def test_diff_sort_name():
    ...
    assert diff.text.splitlines() == [
        ...
        '@@ -4,13 +4,13 @@',
        '',
        '   2   4    1  FID  7.00 8x8   1   1    25',
        '   3   5    2  FID  7.00 8x8   1   1    25',
        ' --- --- ---- ---- ----- --- --- --- -----',
        '-  7 107    6  GU*  6.50 6x6   1   1    25',
        '   6 106    5  GU*  7.00 6x6   1   1    25',
        '   5 105    4  GU*  7.50 6x6   1   1    25',
        '   8 103    7  GUI  8.50 6x6   1   1    25',
        '   4 101    3  GU*  9.50 6x6   1   1    25',
        ' --- --- ---- ---- ----- --- --- --- -----',
        '-  7 107    6  AC*  6.50 6x6  20   1   160',
        '+  7 100    6  MON  6.50 8x8  20   1    25',
        '+--- --- ---- ---- ----- --- --- --- -----',
...
def test_diff_get_catalog_lines():
    ...
    assert lines == [
        ...
        '---- --- --- ---- --- ----- ----- -------- --- -----',
        '   0   1   2  FID 8x8 0.000  7.00 -1742.03   1    25',
        '   1   2   4  FID 8x8 0.000  7.00   166.63   1    25',
        '   2   3   5  FID 8x8 0.000  7.00   160.17   1    25',
        '---- --- --- ---- --- ----- ----- -------- --- -----',
        '   5   6 106  GU* 6x6 0.982  7.00   750.00   1    25',
        '   4   5 105  GU* 6x6 0.981  7.50  -750.00   1    25',
        '   7   8 103  GUI 6x6 0.000  8.50 -1500.00   1    25',
        '   3   4 101  GU* 6x6 0.935  9.50  1500.00   1    25',
        '---- --- --- ---- --- ----- ----- -------- --- -----',
        '   6   7 100  MON 8x8 0.982  6.50  -750.00  20    25',
        '---- --- --- ---- --- ----- ----- -------- --- -----',
        '   5   6 106  AC* 6x6 0.982  7.00   750.00  20   160',
        '   4   5 105  AC* 6x6 0.981  7.50  -750.00  20   160',
