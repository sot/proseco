...
def test_get_aca_catalog_20603():
    ...
    exp = ['slot idx     id    type  sz   yang     zang   dim res halfw',
           ...
           '   2   3  40112304  BOT 6x6 -1644.35  2032.47  12   1    80',
           '   3   4  40114416  BOT 6x6   394.22  1204.43  24   1   140',
           '   4   5 116791824  BOT 6x6   622.00  -953.60  28   1   160',
           '   5   6  40113544  GUI 6x6   102.74  1133.37   1   1    25',
           '   5   7 116923496  ACQ 6x6 -1337.79  1049.27  20   1   120',
           '   6   8 116923528  ACQ 6x6 -2418.65  1088.40  28   1   160',
           '   7   9 116791744  ACQ 6x6   985.38 -1210.19  28   1   160',
           '   0  10  40108048  ACQ 6x6     2.21  1619.17  24   1   140']
...
def test_get_aca_catalog_20259():
    ...
    exp = ['slot idx     id    type  sz   yang     zang   dim res halfw',
           ...
           '   4   5 896009240  BOT 6x6  -911.41   402.62  12   1    80',
           '   5   6 896013056  BOT 6x6  1547.25 -2455.12  12   1    80',
           '   6   7 897712576  BOT 6x6 -1099.95  2140.23  12   1    80',
           '   7   8 897717296  BOT 6x6   932.58  1227.48  12   1    80',
...
def test_dense_star_field_regress():
    ...
    exp = ['slot idx     id     type  sz   yang     zang   dim res halfw mag ',
           ...
           '   4   5 1130890288  BOT 6x6  2030.55 -2011.89  28   1   160 7.67',
           ...
           '   6   9 1130899056  ACQ 6x6  2386.83 -1808.51  28   1   160 6.24',
           '   7  10 1130770696  ACQ 6x6 -1900.42  2359.33  28   1   160 7.35',
           '   0  11 1130890616  ACQ 6x6  1472.68  -376.72  28   1   160 7.77',
           '   1  12 1130893640  ACQ 6x6    64.32 -1040.81  28   1   160 7.77',
           '   2  13 1130894376  ACQ 6x6  -633.90  1186.80  28   1   160 7.78']
