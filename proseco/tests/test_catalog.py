...
def test_get_aca_catalog_20603():
    ...
    exp = ['slot idx     id    type  sz   yang     zang   dim res halfw',
           ...
           '   6   7 116791744  BOT 6x6   985.38 -1210.19  20   1   140',
           '   7   8  40113544  GUI 6x6   102.74  1133.37   1   1    25',
           '   7   9 116923496  ACQ 6x6 -1337.79  1049.27  20   1   120',
           '   0  10 116785920  ACQ 6x6  -673.94 -1575.87  20   1    60']
...
def test_get_aca_catalog_20259():
    ...
    exp = ['slot idx     id    type  sz   yang     zang   dim res halfw',
           ...
           '   4   5 897717296  BOT 6x6   932.58  1227.48  20   1   160',
           '   5   6 897712576  BOT 6x6 -1099.95  2140.23  20   1   160',
           '   6   7 896013056  BOT 6x6  1547.25 -2455.12  20   1   160',
           '   7   8 897722680  GUI 6x6  1007.82  1676.78   1   1    25',
           '   7   9 896011576  ACQ 6x6   810.99   -69.21  20   1   160',
           '   0  10 897192352  ACQ 6x6 -2110.43  2005.21  20   1   100',
           '   1  11 896008728  ACQ 6x6  2223.64  -341.57  20   1    80',
           '   2  12 896010144  ACQ 6x6  1081.11   912.90  20   1    80']
    repr(aca)  # Apply default formats
    assert aca[TEST_COLS].pformat(max_width=-1) == exp
