...
def test_get_aca_catalog_20603():
    ...
    aca = get_aca_catalog(20603, exclude_ids_acq=[40113544], n_fid=2, n_guide=6, n_acq=7,
                          raise_exc=True)
    # Expected 2 fids, 5 guide, 7 acq
    exp = ['slot idx     id    type  sz   yang     zang   dim res halfw',
           '---- --- --------- ---- --- -------- -------- --- --- -----',
           '   0   1         4  FID 8x8  2140.23   166.63   1   1    25',
           '   1   2         5  FID 8x8 -1826.28   160.17   1   1    25',
           '   2   3 116923496  BOT 6x6 -1337.79  1049.27  20   1   120',
           '   3   4 116791824  BOT 6x6   622.00  -953.60  28   1   160',
           '   4   5  40114416  BOT 6x6   394.22  1204.43  24   1   140',
           '   5   6  40112304  BOT 6x6 -1644.35  2032.47  12   1    80',
           '   6   7  40113544  GUI 6x6   102.74  1133.37   1   1    25',
           '   0   8 116923528  ACQ 6x6 -2418.65  1088.40  28   1   160',
           '   1   9 116791744  ACQ 6x6   985.38 -1210.19  28   1   160',
...
def test_get_aca_catalog_20259():
    ...
    exp = ['slot idx     id    type  sz   yang     zang   dim res halfw',
           ...
           '   6   7 896009240  BOT 6x6  -911.41   402.62  12   1    80',
           '   7   8 896008536  GUI 6x6  1705.59   158.91   1   1    25',
           '   0   9 896011576  ACQ 6x6   810.99   -69.21  16   1   100',
           '   1  10 896013056  ACQ 6x6  1547.25 -2455.12  12   1    80',
           '   2  11 897718208  ACQ 6x6   765.61  1530.27  12   1    80',
           '   7  12 897192352  ACQ 6x6 -2110.43  2005.21  12   1    80']
