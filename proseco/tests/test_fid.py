...
def test_get_initial_catalog():
    ...
    exp = ['<FidTable length=6>',
           ...
           '----- -------- -------- ------- ------- ------- ------------- -----',
           '    1   922.59 -1737.89 -180.05 -344.10    7.00             0   -99',
           '    2  -773.20 -1742.03  160.79 -345.35    7.00             0     0',
           '    3    40.01 -1871.10   -2.67 -371.00    7.00             0   -99',
           '    4  2140.23   166.63 -424.51   39.13    7.00             0     1',
           '    5 -1826.28   160.17  372.97   36.47    7.00             0     2',
           '    6   388.59   803.75  -71.49  166.10    7.00             0   -99']
    ...
    exp = ['<FidTable length=6>',
           ...
           'int64 float64  float64  float64 float64 float64     int64     int64',
           '----- -------- -------- ------- ------- ------- ------------- -----',
           '    1   922.59 -1737.89 -180.05 -344.10    7.00             4   -99',
           '    2  -773.20 -1742.03  160.79 -345.35    7.00             4   -99',
...
def test_fid_spoiling_acq(dither_z):
    ...
    exp = ['<FidTable length=6>',
           ...
           '    2  -773.20 -1742.03  160.79 -345.35    7.00             0   -99',
           '    3    40.01 -1871.10   -2.67 -371.00    7.00             0   -99',
           '    4  2140.23   166.63 -424.51   39.13    7.00             0   -99',
